  ...
  return (
    <section className="relative h-[300px] md:h-[360px] w-full flex flex-col justify-center px-6 md:px-10 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 w-full h-full">
        <img 
          // هنا بنبدل الصورة: img3 للوضع العادي، وصورة تانية (مثلاً img-dark) للوضع الداكن
          // لو معندكيش صورة تانية، ممكن تسيبيها img3 وهنعتمد على التعتيم
          src="/img3.jpg" 
          alt="Background" 
        ...
        {/* في الوضع العادي لونها أزرق TMDB المعتاد، وفي الدارك بنخليها أسود غامق جداً */}
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="relative mt-8 max-w-[1200px]">
          <input 
            ...
            // عدلنا ألوان الـ input عشان تناسب الدارك مود
